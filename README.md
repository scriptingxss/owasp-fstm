...
$ ubireader\_extract\_images -u UBI -s &lt;start offset&gt; &lt;bin&gt;
...
$ sudo ./start\_all\_installed\_fact\_components
 ...
 __Navigate to [http://127.0.0.1:5000](http://127.0.0.1:5000/) in browser
...
Partial RELRO No canary found NX enabled No PIE No RPATH No RUNPATH No Symbols No 0 0 /home/embedos/firmware/\_IoTGoat-openwrt-x86-generic-combined-squashfs.img.extracted/squashfs-root/bin/busybox
...
Partial RELRO No canary found NX enabled No PIE No RPATH No RUNPATH No Symbols No 0 0 /home/embedos/firmware/\_IoTGoat-openwrt-x86-generic-combined-squashfs.img.extracted/squashfs-root/usr/bin/shellback
...
The following example shows Busybox emulated within a x64 architecture. 
...
Currently defined functions:
 ...
 \[, \[\[, addgroup, adduser, arp, arping, basename, bunzip2, bzcat, bzip2, cat, chmod, chpasswd, cp, cryptpw, cut, date, dd, delgroup, deluser,

 df, du, echo, egrep, expr, false, fdisk, fgrep, free, grep, gunzip, gzip, halt, hostname, ifconfig, init, insmod, ip, ipaddr, iplink, iproute,

 iprule, iptunnel, kill, killall, killall5, ln, ls, lsmod, mkdir, mknod, mkpasswd, modprobe, mount, msh, mv, netstat, passwd, ping, ping6,

 poweroff, ps, pwd, reboot, rm, rmmod, route, sed, sh, sleep, sysctl, tar, test, top, touch, tr, true, tunctl, umount, uname, uptime, vconfig,
...
Creating TAP device tap2\_0...

Set 'tap2\_0' persistent and owned by uid 0
